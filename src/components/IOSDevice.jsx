...
// Ported from the design project's ios-frame.jsx starter, trimmed to the parts
// the Family Expense Tracker screen actually mounts: the bezel, the status bar,
// the dynamic island and the home indicator. No assets, no deps.
//
// The raw hex/px values below are deliberate — this is device chrome imitating
// iOS, not app surface, so it sits outside the Organic token system.
  ...
  return (
    <div style={{
      ...
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        {/* Screens manage their own scrolling, so the frame itself never scrolls. */}
